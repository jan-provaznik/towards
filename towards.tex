...
% \ArticleTitle
%   {Practical limitations of feasible preparation of optical states with higher stellar rank}
\ArticleTitle
...
\section{Herlading Fock states of travelling light}
...
\end{equation}
%
If these quantities satisfy the inequality~${y_{m} \geq F_{m} (x_{m})}$, the density operator~$\hatrho$ represents a genuine~$m$-PQnG state. The threshold function~$F_{m}(x)$ in the inequality can be obtained through sophisticated numerical optimization~\cite{lachman2019,fiurasek2022}.
...
The software implementation of the numerical simulations is available through a public repository~\cite{source}. The repository also includes the software required to produce the visual representation of the results. The datasets necessary to exactly reproduce the figures presented within the manuscript are available through the same repository.

\FloatBarrier
\section*{Acknowledgements}

PM and JP acknowledge Grant No. 22-08772S of the Czech Science Foundation.
RF, PM and JP acknowledge the European Union's HORIZON Research and Innovation Actions under Grant Agreement no. 101080173 (CLUSTEC), 101017733 and 731473 (CLUSSTAR). RF and PM also aknowledge the project CZ.02.01.01/00/22\_008/0004649 (QUEENTEC) of EU and MEYS Czech Republic. OS acknolwedges funding from the Danish National Research Foundation (bigQ~DNRF~142).
%
