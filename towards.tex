...
This figure demonstrates the stark difference between the requirements imposed on the preparation of different m-PQnG states. For example, when targeting the $5$-PQnG state and using a simpler CAP detector (10 constituent photodiodes, dotted line), the maximal tolerable loss in characterization is lower than $5\%$. It reaches zero for roughly $30\%$ loss in heralding. Conversely, the thresholds for the $3$-PQnG state are much greater, with the tolerable characterization loss exceeding $20\%$ even when the heralding loss reaches $40\%$.
