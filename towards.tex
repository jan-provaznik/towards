...
\begin{figure}[h]
  \bgroup
    \hspace*{-0.125\columnwidth}%
    \includegraphics[width = 1.25 \columnwidth]{import/202504/paper_unified_04.pdf}
  \egroup
  \caption{
...
\begin{figure}[h]
  ...
  \end{center}
  \caption{
    Thresholds of the tolerable loss in simulated preparation of certifiable genuine $3$~(black), $4$~(red), and $5$-PQnG (blue) states. The thresholds are determined using the same methodology as the results visualised in \figref{f-res-4} and \figref{f-res-5} where the minimal probability of success is limited to $10^{-5}$.
    %
